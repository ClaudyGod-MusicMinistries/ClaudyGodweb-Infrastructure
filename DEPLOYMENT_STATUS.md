...
- **Issue:** Deployment was blocking on missing Paystack and AIProvider API keys
...
| `AI_PROVIDER_API_KEY` | AI validation for Zelle transfers | ⏳ Can be added later |
...
4. **Configure** optional features (Paystack, AIProvider) when ready
